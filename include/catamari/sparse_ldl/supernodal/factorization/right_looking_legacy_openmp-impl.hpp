 ...
 */
#ifndef CATAMARI_SPARSE_LDL_SUPERNODAL_FACTORIZATION_RIGHT_LOOKING_LEGACY_OPENMP_IMPL_H_
#define CATAMARI_SPARSE_LDL_SUPERNODAL_FACTORIZATION_RIGHT_LOOKING_LEGACY_OPENMP_IMPL_H_
...
bool Factorization<Field>::OpenMPRightLookingLegacySupernodeFinalize(
...
template <class Field>
bool Factorization<Field>::OpenMPRightLookingLegacySubtree(
  ...
  for (Int child_index = 0; child_index < num_children; ++child_index) {
             ...
             work_estimates)
    {
      ...
      successes[child_index] = OpenMPRightLookingLegacySubtree(
  ...
  if (succeeded) {
    ...
    #pragma omp taskgroup
    succeeded = OpenMPRightLookingLegacySupernodeFinalize(
  ...
  if (total_work < min_parallel_work) {
    ...
    for (Int root_index = 0; root_index < num_roots; ++root_index) {
              ...
              shared_state, private_states, work_estimates)
      {
        ...
        successes[root_index] = OpenMPRightLookingLegacySubtree(
...
#endif  // ifndef
// CATAMARI_SPARSE_LDL_SUPERNODAL_FACTORIZATION_RIGHT_LOOKING_LEGACY_OPENMP_IMPL_H_
